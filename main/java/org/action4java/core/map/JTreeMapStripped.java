...
public class JTreeMapStripped <T> {
	 ...
	 */
	public JTreeMapStripped(String delimiter) {
		if (delimiter==null) {
			System.out.println("Delimiter could not be null using default :" );
			return;
		}
		if (delimiter.equals("")) {
			System.out.println("Delimiter could not be empty String using default : " );
			return;
		}
		list.put("",new ArrayList<String>());
	...
	public void put(String key,T value) {		
		...
		// no null key allowed
		if (key==null) {
			System.out.println("Null keys won't be added for ");
			return;
		}
		
		// no null value allowed
		if (value==null) {
			System.out.println("Null values won't be added for " + key);
			return;
		}
		
		// Key already set --> just change values
		if (this.isListKey(key)) {
			System.out.println("The key " + key + " is a list key");
			return;
		}
	...
	public void putPointer(String key,T value) {		
		...
		if (this.pointer.equals("")) {
			System.out.println("pointer is empty for " + key);
			return;
		}
	...
	public T getPointer(String key) {		
		if (key==null) {
			System.out.println("String key is null");
			return null;
		}
		if (this.pointer.equals("")) {
			System.out.println("pointer is empty for " + key);
	...
	public void put(String newKey,HashMap <String,T> newMap) {
		...
		if (!checkTree(newKey)) {
			System.out.println("Parts of the list " + newKey + "would overwrite key/value pairs. please check");
			return;
		}
	...
	public HashMap <String,T>         getHashMap(String key) {
		...
		if (!isListKey(key)) {
			System.out.println("No list defined for " + key);
			return result;
		}
